...
public class App {
	...
	private static void consultar(String dados) {
		...
		if (cliente != null) {
			JOptionPane.showInputDialog(null , "Cliente encontrado" + cliente.toString(),
					"Sucesso", JOptionPane.INFORMATION_MESSAGE);
		} else {
			JOptionPane.showInputDialog(null , "Cliente não encontrado" ,
					"Sucesso", JOptionPane.INFORMATION_MESSAGE);
		}
	...
	private static void cadastrar(String dados) {
		...
		//Se não tiver, passar null no contrutor onde o valor é nulo
		//
		...
		if (isCadastrado) {
			...
			JOptionPane.showInputDialog(null , "Cliente já está cadastrado",
